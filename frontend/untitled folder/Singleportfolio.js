...
export default function Singleportfolio() {
  return (
                ...
                <div className="col-12">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item"><a href="#">Portfolio</a></li>
                            <li className="breadcrumb-item active" aria-current="page">Single Portfolio</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section className="portfolio-details-area section-padding-0-100">
            ...
            <div className="portfolio-text mb-100">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-6">
                        ...
                        <ul>
                            <li><i className="fa fa-check"></i> Vivamus starlord finibus, massa eget, suscipit metus nami at elit started</li>
                            <li><i className="fa fa-check"></i> Cras ipsum libero, suscipit vitamin tellus vitae, feugiat ultricies purus praesent gamora.</li>
                            <li><i className="fa fa-check"></i> Proin ex sem, ultrices drax the sit amet, facilisis destroyer et odio profession risusest.</li>
                            <li><i className="fa fa-check"></i> Morbi maximus mauris eget groot dignissim, in laoreet justo facilisis.</li>
                        </ul>
                    </div>
                    <div className="col-12">
        ...
        {/* Portfolio Slides */}
        <div className="portfolio-slides owl-carousel mb-100">
            {/* Single Portfolio Slide */}
            <div className="single-portfolio-slide">
                <img src="seests/img/bg-img/26.jpg" alt=""/>
            </div>
            {/* Single Portfolio Slide */}
            <div className="single-portfolio-slide">
                <img src="seests/img/bg-img/27.jpg" alt=""/>
            </div>
            {/* Single Portfolio Slide */}
            <div className="single-portfolio-slide">
                <img src="seests/img/bg-img/28.jpg" alt=""/>
            </div>
        </div>
