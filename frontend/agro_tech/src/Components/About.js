    ...
    return (
        <>
            ...
            <div class="breadcrumb-area">
                {/* <!-- Top Breadcrumb Area --> */}
                <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style={{backgroundImage: "url('assets/img/bg-img/24.jpg')"}}>
                    <h2>ABOUT US</h2>
                </div>
            ...
            <section class="cool-facts-area bg-img section-padding-100-0" style={{backgroundImage: "url('img/bg-img/cool-facts.png')"}}>
                <div class="container">
                    <div class="row">
